...
//        $this->log($this->request->getData('id'));
        ...
        {
            $notice = $this->Notices->get($this->request->getData('id'), ['contain' => []]);
        } else
        {
...
//                return $this->redirect(['action' => 'index']);
                ...
                ->withStringBody(json_encode(['result' => 'Success'])); //set up respnose data
                return $this->response;
            }
            $this->response = $this->response->withType('application/json') //setup response type
                ->withStringBody(json_encode(['result' => 'Failed','message'=>'The notice could not be saved. Please, try again.'])); //set up respnose data
                return $this->response;
        }
    }
    ...
    public function deletesingle()
    {
         if($this->request->is('ajax')) { //Ajax request
             ...
             $notice = $this->Notices->get($this->request->getData('id'));
            if ($this->Notices->delete($notice)) {
                ...
                $this->response = $this->response->withType('application/json') //setup response type
                ->withStringBody(json_encode(['result' => 'Failed','message'=>'The notice could not be deleted. Please, try again.'])); //set up respnose data
                return $this->response;
        }
    }
    ...
    {   
        ...
        if($this->request->is('ajax')) { //Ajax request
            $this->response = $this->response->withType('application/json') //setup response type
                ->withStringBody(json_encode($notice)); //set up respnose data
                return $this->response;
        }
    }
...
//    }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            //update database
            $uploadData->name = trim($this->request->data('noticecat'));
