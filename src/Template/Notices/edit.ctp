...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><?= $this->Html->link('<i class="icon-font">&#xe900;</i>'.__('Homepage', true), ['controller' => 'Pages', 'action' => 'display', 'home'], ['escape' => false]); ?><span class="crumb-step">&gt;</span><?= $this->Html->link(__('Notices'), ['controller' => 'Notices', 'action' => 'index'], ['escape' => false]); ?><span class="crumb-step">&gt;</span><span>Edit</span></div>
        </div>
        <?= $this->Flash->render() ?>
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <?= $this->Form->input('noticecat', ['value' => $notice->name, 'size' => '50', 'type' => 'hidden', 'class' => 'common-text required']);?>
                            </td>
                        </tr>
                            <tr>
...
$("#category").change(function(){  
        //code...  
        var category_text=$("#category").find("option:selected").text();  
