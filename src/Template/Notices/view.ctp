...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><?= $this->Html->link('<i class="icon-font">&#xe900;</i>'.__('Homepage', true), ['controller' => 'Pages', 'action' => 'display', 'home'], ['escape' => false]); ?><span class="crumb-step">&gt;</span><?= $this->Html->link(__('Notices'), ['controller' => 'Notices', 'action' => 'index'], ['escape' => false]); ?><span class="crumb-step">&gt;</span><span>View</span></div>
        </div>
        <?= $this->Flash->render() ?>
