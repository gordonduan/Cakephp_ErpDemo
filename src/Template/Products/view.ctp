         ...
         <!--   <?= $this->Flash->render() ?> -->
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?= $this->Form->control('category_id', ['label' =>'', 'options' => $categories, 'class' => 'form-control', 'empty' => true, 'disabled' => true]);?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?= $this->Form->control('price',['label' =>'','class' => 'form-control', 'disabled' => true])?>
                        </div>
                    </div>
                    <div class="form-group">
